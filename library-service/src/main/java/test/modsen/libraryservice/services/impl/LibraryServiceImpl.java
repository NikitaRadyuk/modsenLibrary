...
public class LibraryServiceImpl implements ILibraryService {
    ...
    public void createBookRecord(BookFindDTO bookFindDTO) {
        ...
        Optional<BookRecordEntity> optionalBookRecordEntity = libraryRepository.getBookRecordEntityByUuid(bookFindDTO.getBookUUID());

        optionalBookRecordEntity.ifPresent(
                bookRecordEntity -> {
    ...
    public void updateBook(BookBorrowDTO bookBorrowDTO) {
        ...
        Optional<BookRecordEntity> optionalBookRecordEntity = libraryRepository.getBookRecordEntityByUuid(bookBorrowDTO.getBookUUID());

        optionalBookRecordEntity.ifPresent(
                bookRecordEntity -> {
                    BookRecordEntity bookRecord = libraryRepository.getBookRecordEntityByUuid(bookBorrowDTO.getBookUUID()).get();
